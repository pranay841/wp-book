...
class Wp_Book {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_admin, 'wb_add_book_type' );
		$this->loader->add_action( 'init', $plugin_admin, 'wb_add_tax' );
		$this->loader->add_action( 'plugins_loaded', $plugin_admin, 'wb_meta_link_wpdb' );
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'wb_add_setting_page' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'wb_booksmenu_settings_setup' );
